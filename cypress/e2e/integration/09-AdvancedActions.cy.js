...
describe("Keyboard & Mouse Actions", () => {
  ...
  it("Right Click, and Double Click", () => {
    ...
    // cy.get('#click').should('be.visible').and('have.text', 'Click on me')
    // cy.get('#right-click').should('be.visible').and('have.text', 'Right-Click on me')
    // cy.get('#double-click').should('be.visible').and('have.text', 'Double-Click on me')
